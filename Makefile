...
IMGUI_OBJ = $(addprefix $(BUILD_DIR)/imgui/,$(IMGUI_SOURCES:%.cpp=%.o))

SHARED_ARGS = -O2 -s USE_SDL=2 -std=c++11
LINKER_ARGS = $(SHARED_ARGS) -s USE_WEBGL2=1 -s FULL_ES3=1 -s WASM=1 -s USE_SDL=2 -lGL
